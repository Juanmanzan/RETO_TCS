...
"""
    ...
    Retorna:
        True:
            el lote fue persistido correctamente.

        False:
            actualmente no se utiliza como resultado de error.
            Los errores PostgreSQL se propagan mediante excepción.

    Una transacción duplicada también se considera correctamente
    procesada debido a que PostgreSQL funciona como segunda
    defensa de idempotencia.
"""
